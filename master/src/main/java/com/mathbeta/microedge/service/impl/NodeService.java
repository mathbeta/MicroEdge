...
@Slf4j
@Service
public class NodeService extends BaseService<Node, NodeMapper> implements INodeService {
    @Resource
    ...
    public Result register(NodeRegister nodeRegister) throws BusinessException {
        List<Namespace> namespaces = namespaceMapper.query(ParamBuilder.builder()
                .put("name", nodeRegister.getNamespace())
                .build());
