...
VALUES('1', 'default', 'default namespace', '2023-10-08 07:52:59');
...
CREATE TABLE `edge_app_version` (
  ...
  `registry_id` varchar(32) NOT NULL DEFAULT '0' COMMENT 'docker镜像仓库id',
  `running_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'json格式容器运行配置，用于启动docker容器。\r\nenv，环境变量，格式["a=1", "b=2"]\r\nportMappings，端口映射，格式["8080:80", "6443:443"]\r\nvolumeMappings，卷映射，格式["/path/on/host:/path/on/container"]',
  `description` text COMMENT '描述',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='应用版本';
...
CREATE TABLE `edge_docker_registry` (
	...
	is_public tinyint DEFAULT 1 NULL COMMENT '是否为公共仓库（公共仓库可以只通过url访问，不需要账号密码）',
	create_time datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`)
...
VALUES('0', 'registry.hub.docker.com', NULL, NULL, NULL, 1, '2023-10-08 08:16:41');
INSERT INTO edge_docker_registry
(id, url, user_email, user_name, password, is_public, create_time)
VALUES('1', 'from_cache', NULL, NULL, NULL, 1, '2023-10-08 08:17:02');
